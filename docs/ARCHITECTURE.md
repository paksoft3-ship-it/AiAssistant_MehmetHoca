...
- **Phase 1 (in progress):** local parser deps, Dexie persistence, repositories, localStorage→IndexedDB migration, config/product + featureFlags, incremental file splitting.
